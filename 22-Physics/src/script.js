...
debugObject.reset = () => {
    ...
    for ( const object of boxToUpdate ){
        // Remove body
        object.body.removeEventListener('collide',playHitSound);
        world.removeBody(object.body);
    ...
    boxToUpdate.splice(0,boxToUpdate.length)
...
const boxMaterial = new THREE.MeshStandardMaterial({ metalness: 0.5, roughness: 0.3, envMap: environmentMapTexture });
